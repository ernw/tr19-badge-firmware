...
This repository contains the TROOPERS 19 badge firmware which is based upon micropython.

Relevant files for TR19 badge are:
- `ports/esp32/modules/{bootstrap.py,system/,libs/,apps/}`
- `ports/esp32/moddisplay/`
